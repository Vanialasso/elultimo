...
enum TTCExecCtrl {
	ExecCtrlPrioTC, ExecCtrlReboot, ExecCtrlHK_FDIRTC, ExecCtrlBKGTC,ExecObsMngTC
};
...
class CDTCExecCtrl{
	...
	bool GLastImage(){return (ExecObsMngTC==mExecCtrl);}
	bool GReadyToObservation(){return (ExecObsMngTC==mExecCtrl);}
	/**
