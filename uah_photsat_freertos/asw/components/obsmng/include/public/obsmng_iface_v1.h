 ...
 *
 */
class ObsMng: public CEDROOMComponent {

public:

	/**
	 * \enum TEDROOMObsMngSignal
	 * \brief Component Signal Enum Type
	 *
	 */
	 enum TEDROOMObsMngSignal { EDROOMSignalTimeout, 
							EDROOMSignalDestroy, 
							SObsMng_TC };

	/**
	 * \class ObsMng::CEDROOMMemory
	...
	//! Constructor
	ObsMng(TEDROOMComponentID id, TEDROOMUInt32 roomNumMaxMens, TEDROOMPriority roomtaskPrio, 
